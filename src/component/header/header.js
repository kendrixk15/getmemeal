...
function Header() {
  return (
    <div className="font-kanit">
      {/* desktop */}
      <div className="hidden h-14 bg-mainBlue lg:flex items-center justify-end px-16 ">
      ...
      {/* Mobile */}
      <div className="lg:hidden h-14 px-2 bg-mainBlue flex items-center justify-between">
        <Link to={"/"}>
